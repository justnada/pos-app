                ...
                <div id="auth-left">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <x-jet-input  type="email" class="block mt-1 w-full" name="email" :value="old('email')" required autofocus />
                            <div class="form-control-icon">
                                <i class="bi bi-person"></i>
                            </div>
                        </div>
                        <div class="form-group position-relative has-icon-left mb-4">
                            <x-jet-input  type="password" class="block mt-1 w-full" name="password" required autocomplete="current-password"/>
                            <div class="form-control-icon">
